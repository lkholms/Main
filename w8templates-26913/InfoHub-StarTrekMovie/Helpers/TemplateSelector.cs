...
namespace InfoHub.Helpers
{
    public class TemplateSelector: DataTemplateSelector
    {
        protected override Windows.UI.Xaml.DataTemplate SelectTemplateCore(object item, Windows.UI.Xaml.DependencyObject container)
        {
            ...
            if (item is PosterArticle)
                return PosterTemplate;
            if (item is MiniArticle)
                return MiniTemplate;
        ...
        public Windows.UI.Xaml.DataTemplate CastTemplate { get; set; }
        public Windows.UI.Xaml.DataTemplate SummaryTemplate { get; set; }
        public Windows.UI.Xaml.DataTemplate WeatherTemplate { get; set; }
        public Windows.UI.Xaml.DataTemplate CalendarTemplate { get; set; }
        public Windows.UI.Xaml.DataTemplate AdvertTemplate { get; set; }
        public Windows.UI.Xaml.DataTemplate MiniTemplate { get; set; }
        public Windows.UI.Xaml.DataTemplate PosterTemplate { get; set; }
    }
}
